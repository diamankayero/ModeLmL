// Les quatre fonctionnalités, en cartes façon Notion :
// fond beige très doux, petite icône dans un carré coloré, titre, phrase.
...
const FEATURES = [
  ...
  },
  {
    ...
    text: "Un formulaire pré-rempli avec des valeurs typiques : faites varier une variable et observez la prédiction.",
  },
  {
    icon: FileSearch, tint: "bg-amber-100 text-amber-700",
    title: "Analysez en profondeur",
    text: "Un rapport exploratoire complet : corrélations, distributions, outliers, normalité, multicolinéarité.",
  },
];
  ...
  return (
    <section id="fonctionnalites" className="mx-auto max-w-6xl px-6 py-20">
      ...
      <p className="mx-auto mt-3 max-w-xl text-center text-neutral-600">
        Quatre onglets, zéro configuration : l'atelier suit le chemin naturel
        d'un projet de machine learning.
      </p>
      <div className="mt-12 grid gap-5 sm:grid-cols-2">
        {FEATURES.map(({ icon: Icon, tint, title, text }) => (
          <div key={title}
               className="rounded-2xl bg-[#f7f6f3] p-7 transition-transform hover:-translate-y-0.5">
